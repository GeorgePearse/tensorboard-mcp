...
export class RunService {
  ...
  async getScalars(run: string, tag?: string): Promise<Record<string, ScalarData[]>> {
  ...
  async compareRuns(runIds: string[], metric: string): Promise<Record<string, any>> {
